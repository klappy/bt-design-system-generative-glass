...
(() => {
  const base = '../..';
  for (const p of ["tokens/fonts.css","tokens/colors.css","tokens/typography.css","tokens/spacing.css","tokens/radius.css","tokens/elevation.css","tokens/glass.css","tokens/motion.css","tokens/theme-dark.css","styles.css"]) {
  ...
  window.ggDsBundle = new Promise((resolve) => {
