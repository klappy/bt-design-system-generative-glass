...
export function GlassSearch({value,onChange,placeholder='Search',height=52,style,...rest}){
  ...
  return React.createElement('div',{style:{display:'flex',alignItems:'center',gap:12,height,padding:'0 20px',borderRadius:'var(--r-pill)',background:'var(--glass-fill-2)',border:'var(--border-glass)',
