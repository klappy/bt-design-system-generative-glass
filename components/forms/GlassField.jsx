...
export function GlassField({label,value,onChange,placeholder,type='text',style,...rest}){
  ...
  return React.createElement('label',{style:{display:'grid',gap:6,...style}},
    ...
    React.createElement('input',{type,value,onChange,placeholder,onFocus:()=>setF(true),onBlur:()=>setF(false),style:{height:48,padding:'0 18px',borderRadius:'var(--r-pill)',background:'var(--glass-fill-2)',border:'var(--border-glass)',
